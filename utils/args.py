...
def add_argument_base(arg_parser):
    ...
    # arg_parser.add_argument('--testdata_path', default='./data', help='root of data')
    ...
    arg_parser.add_argument('--max_epoch', type=int, default=300, help='terminate after maximum epochs')
